...
class _PaymentState extends State<Payment> {
  ...
  String _error;
  final String _currentSecret = "sk_test_51FgvGZGBvOXCYDiWwBfq0dQHXAIgNX6inxZyGu5lQchc4t8K6LmXl3E7GkQ4jXSwGmVzEtBg00IIJnPFVzRA65IO00cl27Mgvz"; //set this yourself, e.g using curl
  ...
  initState() {
    ...
    StripePayment.setOptions(
        StripeOptions(publishableKey: "pk_test_epIXK37GRWEUoNgydLMDyLrf00X6dqc90L",
            merchantId: "merchant.flutter.stripe.test",
            androidPayMode: 'test'));
  }
